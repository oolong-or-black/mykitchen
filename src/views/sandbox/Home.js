  ...
  return (
    <div id='Home'>  
      <Card 
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Fast Food')}
      ...
      <Card
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Fat Control')}
      ...
      <Card
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Spicy Food')}
      ...
      <Card
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Noddles')}
      ...
      <Card
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Grilled')}
      ...
      <Card
        hoverable
        bordered={false}
        onClick={()=>navigate('/mykitchen/groups/Sweeties')}
